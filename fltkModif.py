#LA MODIFICATION APPORTER EST UN RENVOIS DE __canevas A LA CREATION DE LA FENETRE AFIN D'UTILISER
#TKINTER DANS LE PROJET
...
def cree_fenetre(largeur, hauteur, frequence=100):
    ...
    return __canevas #UNIQUE MODIFICATION
